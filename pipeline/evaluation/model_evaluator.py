...
class ModelEvaluator:
    ...
    def plot_training_history(self, metrics=('loss', 'accuracy'), figsize=(12, 4)):
        ...
        self._plot_history(self.history, metrics=metrics, figsize=figsize)
        print(f"Training history plot saved to {self.models_dir}/")

    def _plot_history(self, history, metrics=('loss', 'accuracy'), figsize=(12, 4)):
        """
        Internal method to plot training history.
        ...
        plot_path = os.path.join(self.models_dir, f"{self.model_name.lower().replace(' ', '_')}_training_history.png")
